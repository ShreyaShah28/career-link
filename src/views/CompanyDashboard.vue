    ...
    <div class="flex-1 p-8">
      <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <router-link to="/company/manage-jobs" class="card hover:shadow-xl transition-shadow cursor-pointer">
          ...
          <router-link to="/company/post-job" class="card hover:shadow-xl transition-shadow cursor-pointer">
            <div class="flex items-center">
