  ...
  <div class="flex">
    ...
    <div class="flex-1 p-8">
      <div class="max-w-7xl mx-auto">
        <div class="mb-8">
          <router-link to="/company/manage-jobs" class="text-primary-600 hover:text-primary-700 mb-4 inline-flex items-center">
        ...
        <div v-else class="space-y-6">
          <div 
            v-for="application in sortedApplicants" 
            :key="application.id"
            class="card"
          >
            <div class="flex items-start justify-between mb-4">
              <div class="flex-1">
                <div class="flex items-center gap-3 mb-2">
                  <h3 class="text-xl font-semibold text-gray-900">{{ application.applicantName }}</h3>
                  <span 
            ...
            <div class="mb-4">
              ...
              <p class="text-gray-700 text-sm bg-gray-50 p-4 rounded">{{ application.resume }}</p>
            </div>

            <!-- Cover Letter -->
            <div class="mb-4">
              <h4 class="font-semibold text-gray-900 mb-2">Cover Letter</h4>
              <p class="text-gray-700 text-sm bg-gray-50 p-4 rounded">{{ application.coverLetter }}</p>
            </div>
