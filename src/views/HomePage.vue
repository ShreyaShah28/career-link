  ...
  <div>
    ...
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div v-for="job in featuredJobs" :key="job.id" class="card cursor-pointer">
        ...
        <div class="text-center mt-8">
          <router-link to="/jobs" class="btn-primary"> View All Jobs </router-link>
        </div>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">
              Check your resume compatibility and apply with confidence
            </p>
          </div>
          <div class="text-center">
            <div
    ...
    <section class="bg-primary-600 text-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <router-link
          to="/login"
          class="bg-white text-primary-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-block"
        >
          Sign Up Now
        </router-link>
      </div>
