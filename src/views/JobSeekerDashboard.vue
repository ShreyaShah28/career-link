  ...
  <div class="flex">
    ...
    <div class="flex-1 p-8">
      <div class="max-w-7xl mx-auto">
        ...
        <!-- Quick Actions -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <router-link to="/jobs" class="card hover:shadow-xl transition-shadow cursor-pointer">
          ...
          <router-link to="/my-applications" class="card hover:shadow-xl transition-shadow cursor-pointer">
            <div class="flex items-center">
          ...
          <router-link to="/ats-check" class="card hover:shadow-xl transition-shadow cursor-pointer">
            <div class="flex items-center">
          ...
          <div v-else class="space-y-4">
            ...
            >
              <div class="flex items-start justify-between">
                <div class="flex-1">
                  <h3 class="text-xl font-semibold text-gray-900 mb-2">{{ application.jobTitle }}</h3>
                  <div class="flex items-center gap-3 mb-2">
                    ...
                    <span class="text-sm text-gray-600">
                      ATS Score: <span class="font-semibold" :class="getScoreTextClass(application.atsScore)">
                        {{ application.atsScore }}%
                      </span>
                    </span>
                  </div>
                  <p class="text-sm text-gray-500">Applied on {{ application.appliedDate }}</p>
                </div>
              </div>
            </div>
          </div>
