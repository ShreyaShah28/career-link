...
function getScoreMessage(score) {
  if (score >= 80)
    return 'Your resume is well-optimized for this position. You have a strong chance of passing the ATS.'
  if (score >= 60)
    return 'Your resume has a decent match. Consider adding more relevant keywords to improve your score.'
  if (score >= 40)
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="mb-8">
        ...
        <p class="text-gray-600">
          Check how well your resume matches job requirements before applying. Our ATS
          (Applicant Tracking System) checker analyzes keyword matches to help you
          ...
          >
            ...
            <ul class="space-y-2 text-sm text-gray-700">
              ...
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2">•</span>
                <span
                  >Include these keywords in your skills section, experience, and
                  summary</span
                >
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2">•</span>
                <span
                  >Use exact keyword matches when possible (e.g., "JavaScript" not
                  "JS")</span
                >
              </li>
              <li class="flex items-start">
                <span class="text-yellow-600 mr-2">•</span>
                <span
                  >Avoid keyword stuffing - keep your content natural and readable</span
                >
              </li>
            </ul>
          </div>
